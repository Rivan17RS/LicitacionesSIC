...
{
    public class StockProductosCrudFactory: CrudFactory
    {
        private StockProductosMapper mapper;
        public StockProductosCrudFactory() : base()
        {
            mapper = new StockProductosMapper();
