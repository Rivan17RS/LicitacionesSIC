...
{
    public class AdjudicacionesCrudFactory : CrudFactory
    {
        private AdjudicacionesMapper mapper;
        public AdjudicacionesCrudFactory() : base()
        {
            mapper = new AdjudicacionesMapper();
